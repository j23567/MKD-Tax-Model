#View(CPA_TAXABLE_PROPORTIONS_SIM)
suppressMessages({
        ...
        # new 7/12/2024
           ...
           # SIMULATION_2$Simulation_Toggles_Reduced_Rate<-TE_EXEMPT
            ...
            CPA_PRODUCTS_SIM$BM_Rev$Final_Demand_HH[grepl("Imputed rents of owner-occupied dwellings", CPA_PRODUCTS_SIM$BM_Rev$PRODUCT_INDUSTRY_NAME)] <- 0
            ...
            CPA_PRODUCTS_SIM$BM_Rev$Final_Demand_NPISH[grepl("Imputed rents of owner-occupied dwellings", CPA_PRODUCTS_SIM$BM_Rev$PRODUCT_INDUSTRY_NAME)] <- 0
            ...
            CPA_PRODUCTS_SIM$BM_Rev$Final_Demand_Government[grepl("Imputed rents of owner-occupied dwellings", CPA_PRODUCTS_SIM$BM_Rev$PRODUCT_INDUSTRY_NAME)] <- 0
  ...
  # 1.4 Est Rev ----
            ...
            CPA_PRODUCTS_EST_CAL_FACTOR_SIM$Est_Rev$Final_Demand_HH[CPA_PRODUCTS_EST_CAL_FACTOR_SIM$Est_Rev$PRODUCT_INDUSTRY_NAME == "Constructions and construction works"] <- 
              ...
              # NEW 12/07/2024
              (1-SIM_SCENARIO_EST_CAL_FACTOR_SIM$Simulated_Policy_Exempt[62])*vat_rate_on_residential_construction
            ...
            CPA_PRODUCTS_EST_TE = copy(CPA_PRODUCTS_SIM)
  ...
  # 2. SIMULATION RESULTS ----  
            ...
            Results_EST_TE$VAT_Gap$Calibrated_VAT_Est.LCU <- sum(CPA_PRODUCTS_EST_TE$Est_Rev$Final_Demand_Total, na.rm = T)*Locked_Calibration_Factor
            ...
            # 
            # 
            # Results_EFFECTIVE_VAT_RATE$VAT_Gap$Calibrated_VAT_Est.LCU <- sum(CPA_PRODUCTS_EFFECTIVE_VAT_RATE$Est_Rev$Final_Demand_Total, na.rm = T)*Locked_Calibration_Factor
            ...
            # Results_EFFECTIVE_VAT_RATE$VAT_Gap$Calibration_Factor <- Locked_Calibration_Factor 
            # 
            # 
            # 
            # # Final output - Change in Revenues
