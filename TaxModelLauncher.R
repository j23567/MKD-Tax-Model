  ...
  dashboardSidebar(
    sidebarMenu(
      ...
      menuItem("Indirect Taxes", icon = icon("shopping-bag"),
               ...
               menuSubItem("Customs Module", tabName = "customsModule", icon = icon("truck")),
  ...
  dashboardBody(
    tabItems(
      ...
      tabItem(
        tabName = "vatModule",
        h3("VAT Module"),
        p("The VAT Gap Model is a framework used to estimate the difference between the potential Value Added Tax (VAT) revenue that could be collected under a benchmark system and the actual VAT revenue collected under the current system. This model is crucial for understanding the efficiency and effectiveness of VAT systems in various countries. The VAT Gap is typically divided into two main components: the VAT Policy Gap and the VAT Compliance Gap. The model is based on the Top-Down Approach, which is an indirect methodology that utilizes national accounts data to compare potential and actual VAT collections, thereby providing a benchmark for assessing the VAT base across different sectors."),
        br(),
      ...
      tabItem(
        ...
        h3("Customs Module"),
        p("The Customs Module provides simulations and analysis for customs policies."),
        br(),
